...
import org.audit4j.core.extra.reflections.scanners.*;
import org.audit4j.core.extra.reflections.scanners.Scanner;
import org.audit4j.core.extra.reflections.serializers.JavaCodeSerializer;
...
import org.audit4j.core.extra.reflections.util.FilterBuilder;
import org.audit4j.core.extra.reflections.util.Utils;
...
import static org.audit4j.core.extra.reflections.ReflectionUtils.*;
import static org.audit4j.core.extra.reflections.util.Utils.*;
 ...
 * <p>In order to save the store metadata, use {@link #save(String)} or {@link #save(String, org.audit4j.core.extra.reflections.serializers.Serializer)}
 * for example with {@link org.audit4j.core.extra.reflections.serializers.XmlSerializer} or {@link org.audit4j.core.extra.reflections.serializers.JavaCodeSerializer}
 * <p>In order to collect pre saved metadata and avoid re-scanning, use {@link #collect(String, com.google.common.base.Predicate, org.audit4j.core.extra.reflections.serializers.Serializer...)}}
...
public class Reflections {
    ...
    /**
     * constructs a Reflections instance and scan according to given {@link org.audit4j.core.extra.reflections.Configuration}
     ...
     * <p>this actually create a {@link org.audit4j.core.extra.reflections.Configuration} with:
     * <br> - urls that contain resources with name {@code prefix}
     * <br> - filterInputsBy where name starts with the given {@code prefix}
     * <br> - scanners set to the given {@code scanners}, otherwise defaults to {@link org.audit4j.core.extra.reflections.scanners.TypeAnnotationsScanner} and {@link org.audit4j.core.extra.reflections.scanners.SubTypesScanner}.
     * @param prefix package prefix, to be used with {@link org.audit4j.core.extra.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} )}
     * @param scanners optionally supply scanners, otherwise defaults to {@link org.audit4j.core.extra.reflections.scanners.TypeAnnotationsScanner} and {@link org.audit4j.core.extra.reflections.scanners.SubTypesScanner}
     */
     ...
     * <ul>
     *     <li>{@link String} - would add urls using {@link org.audit4j.core.extra.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} ()}</li>
     *     <li>{@link Class} - would add urls using {@link org.audit4j.core.extra.reflections.util.ClasspathHelper#forClass(Class, ClassLoader...)} </li>
     *     <li>{@link ClassLoader} - would use this classloaders in order to find urls in {@link org.audit4j.core.extra.reflections.util.ClasspathHelper#forPackage(String, ClassLoader...)} and {@link org.audit4j.core.extra.reflections.util.ClasspathHelper#forClass(Class, ClassLoader...)}</li>
     *     <li>{@link org.audit4j.core.extra.reflections.scanners.Scanner} - would use given scanner, overriding the default scanners</li>
     *     <li>{@link java.net.URL} - would add the given url for scanning</li>
     *     <li>{@link Object[]} - would use each element as above</li>
     * </ul>
     *
     * use any parameter type in any order. this constructor uses instanceof on each param and instantiate a {@link org.audit4j.core.extra.reflections.util.ConfigurationBuilder} appropriately.
     ...
     * and de-serializes them using the default serializer {@link org.audit4j.core.extra.reflections.serializers.XmlSerializer} or using the optionally supplied optionalSerializer
     * <p>
     ...
     * @param optionalSerializer - optionally supply one serializer instance. if not specified or null, {@link org.audit4j.core.extra.reflections.serializers.XmlSerializer} will be used
     */
    ...
    public Set<String> getTypesAnnotatedWithAsString(final Class<? extends Annotation> annotation) {
        return getTypesAnnotatedWithAsString(annotation, false);
    }
    ...
    public Set<String> getTypesAnnotatedWithAsString(final Class<? extends Annotation> annotation, boolean honorInherited) {
        Iterable<String> annotated = store.get(index(TypeAnnotationsScanner.class), annotation.getName());
        Iterable<String> classes = getAllAnnotated(annotated, annotation.isAnnotationPresent(Inherited.class), honorInherited);
        return Sets.newHashSet(concat(annotated, classes));
    }
    ...
    public Set<String> getTypesAnnotatedWithAsString(final Annotation annotation) {
        return getTypesAnnotatedWithAsString(annotation, false);
    }
    ...
    public Set<String> getTypesAnnotatedWithAsString(final Annotation annotation, boolean honorInherited) {
        Iterable<String> annotated = store.get(index(TypeAnnotationsScanner.class), annotation.annotationType().getName());
        Iterable<Class<?>> filter = filter(forNames(annotated, loaders()), withAnnotation(annotation));
        Iterable<String> classes = getAllAnnotated(names(filter), annotation.annotationType().isAnnotationPresent(Inherited.class), honorInherited);
        return Sets.newHashSet(concat(classes,annotated));
    }
    ...
    /** returns the {@link org.audit4j.core.extra.reflections.Store} used for storing and querying the metadata */
    public Store getStore() {
        return store;
    }

    /** returns the {@link org.audit4j.core.extra.reflections.Configuration} object of this instance */
     ...
     * <p>see the documentation for the save method on the configured {@link org.audit4j.core.extra.reflections.serializers.Serializer}
     */
