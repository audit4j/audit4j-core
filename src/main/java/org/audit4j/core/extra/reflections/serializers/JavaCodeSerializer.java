...
import org.audit4j.core.extra.reflections.ReflectionUtils;
import org.audit4j.core.extra.reflections.Reflections;
import org.audit4j.core.extra.reflections.ReflectionsException;
import org.audit4j.core.extra.reflections.scanners.TypeElementsScanner;
...
import static org.audit4j.core.extra.reflections.Reflections.log;
import static org.audit4j.core.extra.reflections.util.Utils.prepareFile;
import static org.audit4j.core.extra.reflections.util.Utils.repeat;
 ...
 * <pre>
 *  Class&#60? extends IMethod> imethod = MyTestModelStore.org.audit4j.core.extra.reflections.TestModel$C4.m1.class;
 *  Method method = JavaCodeSerializer.resolve(imethod);
 * </pre>
 * <p>depends on Reflections configured with {@link org.audit4j.core.extra.reflections.scanners.TypeElementsScanner}
 * <p><p>the {@link #save(org.audit4j.core.extra.reflections.Reflections, String)} method filename should be in the pattern: path/path/path/package.package.classname
 * */
